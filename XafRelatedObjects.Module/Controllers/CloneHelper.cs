...
namespace XafRelatedObjects.Module.Controllers
{
    ...
    {
        //hACK https://github.com/DevExpress-Examples/XPO_how-to-clone-a-persistent-object-e804/blob/20.1.3%2B/CS/SimpleObject/CloneHelper.cs
        ...
        public object Clone(object source, bool synchronize)
        {
            ...
            {
                if (m.FindAttributeInfo(typeof(SkipCloneAttribute)) != null)
                    continue;
