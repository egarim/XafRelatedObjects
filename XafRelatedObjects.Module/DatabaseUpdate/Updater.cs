...
namespace XafRelatedObjects.Module.DatabaseUpdate {
    ...
    public class Updater : ModuleUpdater {
        ...
        public override void UpdateDatabaseAfterUpdateSchema() {
            ...
            if(this.ObjectSpace.GetObjectsCount(typeof(Period),null)==0)
            {
                var Period = this.ObjectSpace.CreateObject<Period>();
                Period.Year = 2022;

                var OneToOne = this.ObjectSpace.CreateObject<OneToOne>();
                OneToOne.Id = 1;
                OneToOne.Period = Period;

                for (int i = 0; i < 5; i++)
                {
                    var OneToMany = this.ObjectSpace.CreateObject<OneToMany>();
                    OneToMany.Period = Period;
                    OneToMany.Id = i;
                }
            }
