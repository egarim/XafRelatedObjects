...
namespace XafRelatedObjects.Blazor.Server {
    public partial class XafRelatedObjectsBlazorApplication : BlazorApplication {
        public XafRelatedObjectsBlazorApplication() {
            InitializeComponent();
        }
        ...
        private void XafRelatedObjectsBlazorApplication_DatabaseVersionMismatch(object sender, DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
            e.Updater.Update();
            e.Handled = true;
#else
